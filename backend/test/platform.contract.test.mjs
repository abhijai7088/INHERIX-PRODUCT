...
test("platform metadata API contract is published in OpenAPI", async () => {
  ...
  try {
    ...
    assert.ok(docs.paths["/meta"], "Expected /meta in OpenAPI paths.");
    assert.ok(docs.paths["/ready"], "Expected /ready in OpenAPI paths.");
    assert.ok(docs.paths["/health"], "Expected /health in OpenAPI paths.");
  } finally {
